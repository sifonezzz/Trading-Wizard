...
public class MainViewController implements Controller {
    ...
    private void handleTitleClick() {
        if (navigationGroup.getSelectedToggle() != null) {
            navigationGroup.getSelectedToggle().setSelected(false);
        }
        showDashboard();
    }
    ...
    @FXML private void showAnalytics() { loadView("AnalyticsView.fxml"); }
    @FXML private void showGoals() { loadView("GoalsView.fxml"); }
    @FXML private void showSettings() { loadView("Settings.fxml"); }
    
    private void showAfterTrading() { System.out.println("After-trading Session button clicked."); }
